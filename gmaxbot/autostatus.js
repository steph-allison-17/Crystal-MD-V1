export async function before(statusUpdate, {
  ...
  const motivationalQuotes = [
    "Believe you can and you're halfway there.GCYBER MD BOT",
    "Every day may not be good, but there is something good in every day.GCYBER MD BOT",
    "The only limit to our realization of tomorrow is our doubts of today.GCYBER MD BOT",
    "Success is not final, failure is not fatal: It is the courage to continue that counts.GCYBER MD BOT",
    "Start where you are. Use what you have. Do what you can.GCYBER MD BOT",
    "Stay positive, work hard, and make it happen.GCYBER MD BOT",
    "You are stronger than you think.GCYBER MD BOT",
    "Dream big and dare to fail.GCYBER MD BOT",
    "Happiness is not something ready-made. It comes from your own actions.GCYBER MD BOT",
    "Difficult roads often lead to beautiful destinations.GCYBER MD BOT"
  ];
